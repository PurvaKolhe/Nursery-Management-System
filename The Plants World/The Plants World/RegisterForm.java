...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
      ...
      //  String bdate = null;
        ...
        else if(checkUsername(uname))
        {
			...
			/*
			 * if(jDateChooser_BDATE.getDate() != null) { SimpleDateFormat dateformat = new
			 * SimpleDateFormat("yyyy-MM-dd"); bdate =
			 * dateformat.format(jDateChooser_BDATE.getDate()); }
			 */
            
        PreparedStatement ps;
        String query = "INSERT INTO `login`(`u_fname`, `u_lname`, `u_uname`, `u_pass`, `r_pass`, `u_address`) VALUES (?,?,?,?,?,?)";
        ...
        try {
            ...
            ps.setString(5, re_pass);
				/*
				 * if(bdate != null) { ps.setString(5, bdate); }else{ ps.setNull(5, 0); }
				 */
    ...
    public boolean checkUsername(String username)
    {
        ...
        String query = "SELECT * FROM `login` WHERE `u_uname` =?";
